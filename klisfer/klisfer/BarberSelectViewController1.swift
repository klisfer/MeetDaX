...
class BarberSelectViewController1: UIViewController , UITableViewDelegate, UITableViewDataSource{
    ...
    override func viewDidLoad() {
        ...
        //back button handler for activity
    ...
    override func viewWillDisappear(_ animated: Bool) {
        ...
        if (self.goingFwd == false){
            objects.sharedManager.stylistDataF2 = objects.sharedManager.stylistDataF3
    ...
    @objc private func btnSelected(sender: UIButton){
        ...
        let calendar = dataToPost.sharedManager.date
        let dur = dataToPost.sharedManager.duration
        let startTime = dataToPost.sharedManager.startTime
        
        
        
        
        let dateComp = startTime?.components(separatedBy: ":")
            ...
            db.collection("bookings").addDocument(data: [
                ...
                if let err = err {
                    ...
                    func myCallback2() {
                        ...
                        objects.sharedManager.stylistDataF3.removeAll()
                        self.goingFwd = true
