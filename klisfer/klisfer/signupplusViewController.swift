...
class signupplusViewController: UIViewController {
    ...
    @IBAction func navBtnAct(_ sender: Any) {
        ...
        let latitude = 54.914340
        let longitude = 9.796964
        
        // function for opening location in apple maps
        openMapForPlace()

        
// code for opening the locatin in google maps
...
//        }
    ...
    func openMapForPlace() {
        ...
        let latitude: CLLocationDegrees = 54.914340
        let longitude: CLLocationDegrees = 9.796964
