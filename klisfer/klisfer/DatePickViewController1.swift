...
class DatePickViewController1: UIViewController {
    ...
    @objc func buttonAction(){
        ...
        let event_date = dateFormattr.string(from: startDate)
        
        dataToPost.sharedManager.date = event_date
        dataToPost.sharedManager.startTime = self.time
        let dur : Int = -270
        ...
        let parameters :  [String : Any] = ["startDate" : event_date, "endDate" : self.time , "currentStylistID" : i ]
