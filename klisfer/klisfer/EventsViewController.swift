...
class EventsViewController: UIViewController , UITableViewDataSource, UITableViewDelegate{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let string = objects.sharedManager.fetchedBookings[indexPath.row].date
        event_date = dateFormatter.date(from: string)
...
//
        ...
        let dates = datFormatter1.string(from: event_date!)
        print("bhadwa: \(dates)")
        cell.dateTime.text = objects.sharedManager.fetchedBookings[indexPath.row].time
        cell.dat.text = ("- \(dates)")
